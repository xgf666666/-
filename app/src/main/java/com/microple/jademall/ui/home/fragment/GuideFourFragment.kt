...
import kotlinx.android.synthetic.main.fragment_guide_four.*
 ...
 * describe:
 */
class GuideFourFragment : BaseMvpViewFragment() {
    /**
     * 获取Fragment的布局资源文件id
     */
    override fun getFragmentLayoutId(): Int = R.layout.fragment_guide_four
