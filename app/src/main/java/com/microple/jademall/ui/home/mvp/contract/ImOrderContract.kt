...
interface ImOrderContract {
    ...
    interface Model{
        ...
        fun pay(token:String,send:String,live:String,cabinet:String,address_id:String,pay_type:String,trade_password:String,sb_id:String,incr_type1:String,incr_type2:String,incr_type3:String ):Observable<BaseResponseEntity<Pay>>
    ...
    abstract class Presenter:BaseMvpPresenter<Model, View>(){
       abstract fun imOrder(token:String,sb_id:String,goods_id:String)
        abstract fun pay(token:String,send:String,live:String,cabinet:String,address_id:String,pay_type:String,trade_password:String,sb_id:String,incr_type1:String,incr_type2:String,incr_type3:String)
